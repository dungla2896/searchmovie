...
import { Skeleton, Col, Row, Image, Button } from 'antd';
...
export default function WatchingMovie() {
    ...
    return(
        <>
            {detailMovie && (
                <Row>
                    <HeaderTags title={detailMovie.original_title} />
                    <Col span={6}>
                        <Image src={`https://image.tmdb.org/t/p/w300${detailMovie.poster_path}`} />
